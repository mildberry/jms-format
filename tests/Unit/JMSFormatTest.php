...
class JMSFormatTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $contentFormatter = $this->createFormatter();
        $this->assertEquals('{"version":"v1","content":[{"block":"headline","modifiers":{"weight":"lg"},"content":[{"block":"text","modifiers":[],"content":"Header "},{"block":"text","modifiers":{"decoration":"italic"},"content":"1"}]},{"block":"paragraph","modifiers":[],"content":[{"block":"text","modifiers":[],"content":"Paragraph "},{"block":"text","modifiers":{"decoration":"bold"},"content":"BOLD"},{"block":"text","modifiers":[],"content":" text inside tag "},{"block":"text","modifiers":{"decoration":"italic"},"content":"BOLD AND ITALIC"},{"block":"image","modifiers":{"src":"https:\/\/www.ya.ru\/favicon.ico"}}]},{"block":"headline","modifiers":{"weight":"md"},"content":[{"block":"text","modifiers":[],"content":"Next header"}]},{"block":"blockquote","modifiers":[],"content":[{"block":"text","modifiers":[],"content":"Block quote text"}]}]}', $contentFormatter->convert('html', 'JMS', $this->getHtmlText()));
    }
