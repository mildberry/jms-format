...
class JMSFormatTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        return '<h1>Header <i class="decoration-bold">1</i></h1><p class="alignment-left" data-paragraph-id="1">Paragraph <b class="color-danger">BOLD</b> text inside tag <b class="decoration-italic">BOLD AND ITALIC</b><i class="decoration-bold"> ITALIC AND BOLD </i><img class="size-wide" src="https://www.ya.ru/favicon.ico"></p><h2>Next header</h2><blockquote>Block <u>quote</u> <del>text</del></blockquote>';
    }
